...
namespace Drupal\enewsletters\Plugin\Field\FieldType;
 ...
 * @FieldType(
 *   id = "newsletter_issue",
 *   label = @Translation("Newsletter issue"),
 *   description = @Translation("An entity field containing an extended entityreference."),
 *   category = @Translation("Custom"),
 *   no_ui = TRUE,
 *   default_widget = "newsletter_issue_widget",
 *   default_formatter = "newsletter_issue_formatter",
