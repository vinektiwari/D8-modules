...
namespace Drupal\enewsletters\Plugin\Derivative;
...
/**
 * Provides dynamic link actions for newsletter content types.
 */
class AddNewsletterIssueActionLinks extends DeriverBase {

  /**
   * {@inheritdoc}
   */
  public function getDerivativeDefinitions($base_plugin_definition) {
    $node_types = enewsletters_get_content_types();
