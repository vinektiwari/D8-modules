...
class SalesforceauthSettingsForm extends ConfigFormBase {
	...
	*/
	public function buildForm(array $form, FormStateInterface $form_state) {
		...
		// $form['overview'] = array(
		// 	'#markup' => t('Manage Salesforce SSO Configuration Settings.'),
		// 	'#prefix' => '<p>',
		// 	'#suffix' => '</p>',
		// );
		$form['restapi'] = array(
		...
		$form['restapi']['salesforce_consumer_key'] = array(
			...
			'#type' => 'textfield',
			'#required' => TRUE,
			'#default_value' => $sf_consumer_key['salesforce_consumer_key'],
		...
		$form['restapi']['salesforce_consumer_secret'] = array(
			...
			'#type' => 'textfield',
			'#required' => TRUE,
			'#default_value' => $sf_consumer_secret['salesforce_consumer_secret'],
			'#prefix' => '<div class="form-group">',
            '#suffix' => '</div>',
		);
		$form['restapi']['salesforce_callback_uri'] = array(
			...
			'#type' => 'textfield',
			'#required' => TRUE,
			'#default_value' => $sf_callback_uri['salesforce_callback_uri'],
			'#prefix' => '<div class="form-group">',
            '#suffix' => '</div>',
		);
		$form['restapi']['salesforce_login_uri'] = array(
			...
			'#type' => 'textfield',
			'#required' => TRUE,
			'#default_value' => $sf_login_uri['salesforce_login_uri'],
			'#prefix' => '<div class="form-group">',
            '#suffix' => '</div>',
		);
		return $form;
	...
	*/
	public function submitForm(array &$form, FormStateInterface $form_state) {
		...
		->set('salesforce_consumer_key', $form_state->getValues('salesforce_consumer_key'))
		->set('salesforce_consumer_secret', $form_state->getValues('salesforce_consumer_secret'))
		->set('salesforce_callback_uri', $form_state->getValues('salesforce_callback_uri'))
		->set('salesforce_login_uri', $form_state->getValues('salesforce_login_uri'))
		->save();
	}
